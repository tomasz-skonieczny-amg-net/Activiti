...
public class NonSerializableFactory implements ObjectFactory {
     ...
     * 
     * @param key
     *            the key into the NonSerializableFactory map to remove.
     ...
     * @param target
     *            the non-Serializable object to bind.
     * @param createSubcontexts
     *            a flag indicating if subcontexts of name should
     ...
     */
    public Object getObjectInstance(Object obj, Name name, Context nameCtx, Hashtable env) throws Exception { // Get the
                                                                                                              // nns
                                                                                                              // value
                                                                                                              // from
                                                                                                              // the
